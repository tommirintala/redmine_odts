...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="text:p[@text:style-name='T1']">
    <xsl:text>*</xsl:text>
    <xsl:apply-templates/>
    <xsl:text>*</xsl:text>
  </xsl:template>
  ...
  <xsl:template match="text:p[@text:style-name='T2']">
    <xsl:text>_</xsl:text>
    <xsl:apply-templates/>
    <xsl:text>_</xsl:text>
  </xsl:template>
  
  <xsl:template match="text:span[@text:style-name='T3']">
    <xsl:text>+</xsl:text>
    <xsl:apply-templates/>
    <xsl:text>+</xsl:text>
  </xsl:template>

  <xsl:template match="text:p[@text:style-name='T3']">
    <xsl:text>+</xsl:text>
    <xsl:apply-templates/>
    <xsl:text>+</xsl:text>
  </xsl:template>
  
  <xsl:template match="text:span[@text:style-name='T4']">
    <xsl:text>-</xsl:text>
    <xsl:apply-templates/>
    <xsl:text>-</xsl:text>
  </xsl:template>
  
  <xsl:template match="text:p[@text:style-name='T4']">
    <xsl:text>-</xsl:text>
    <xsl:apply-templates/>
    <xsl:text>-</xsl:text>
  </xsl:template>
